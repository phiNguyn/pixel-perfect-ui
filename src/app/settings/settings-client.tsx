...
export default function SettingsClient() {
  const { user, isAuthenticated, logout, openLoginModal, updateUser } =
    useAuth();
  ...
  const { data: streakData, isLoading: streakLoading } =
    useQueryStreakProfile(isAuthenticated);
  ...
  // Calculate badge progress for radial chart
  const badgeProgressData = streakData?.badges
    ? [
        {
          name: "Đã đạt",
          value: streakData.badges.filter((b) => b.unlocked).length,
          fill: "#10b981",
        },
        {
          name: "Chưa đạt",
          value:
            ...
            streakData.badges.filter((b) => b.unlocked).length,
          fill: "hsl(var(--muted))",
        },
      ]
    : [];

  // Generate watch time trend data (mock data for demo)
  ...
  const handleSaveEdit = async () => {
    ...
    try {
      ...
      toast.success(
        `Đã cập nhật ${editingField === "name" ? "họ tên" : "tên người dùng"}!`,
      );
              ...
              <div className="bg-card rounded-xl border border-border/50 p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <div className="md:col-span-1 lg:col-span-2">
                    <h3 className="text-sm font-medium mb-3 text-center">
                      Thời gian xem tuần này
                    </h3>
                    <div className="h-40">
                      <StatsAreaChart
                        data={watchTimeTrendData}
                        color="primary"
        ...
        <TabsContent value="privacy" className="space-y-6">
          <div className="bg-card rounded-xl border border-border/50 p-6 space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div>
                  <p className="font-medium text-foreground">Lưu lịch sử xem</p>
                  <p className="text-sm text-muted-foreground">
