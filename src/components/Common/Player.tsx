    ...
    if (!isCurrentlyFullscreen) {
      ...
      try {
        if (container.requestFullscreen) {
          ...
          (video as any).webkitSupportsFullscreen &&
        ...
        >
          ...
          <div className="px-4 mb-2 relative">
            ...
            {isMobile && isFullscreen && (
              <>
                <div className="absolute left-4 -top-8 text-xs z-10">
                  {formatTime(currentTime)}
                </div>
                <div className="absolute right-4 -top-8 text-xs z-10">
                  {formatTime(duration)}
                </div>
              </>
            )}
